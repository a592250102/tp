...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => 'K<?@A1e:{$~Hz/9>n]EVm*"MDxpjkoT0&4uc.57s', //默认数据加密KEY
	'data_cache_key'=> 'K<?@A1e:{$~Hz/9>n]EVm*"MDxpjkoT0&4uc.57s',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'K<?@A1e:{$~Hz/9>n]EVm*"MDxpjkoT0&4uc.57s', //加密KEY
