<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/check\index.html";i:1512025570;s:82:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty()))): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$check): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td><?php echo $check['sn']; ?></td>
            <td><?php echo $check['relation']; ?></td>
            <td><?php echo $check['tel']; ?></td>
            <td><?php echo $check['code']; ?></td>
            <td><?php echo $check['status']; ?></td>
            <td><?php echo $check['create_time']; ?></td>
            <td>
                <a title="通过" href="<?php echo url('yes?uid='.$check['uid'].'&id='.$check['id']); ?>">通过</a>
                <a title="拒绝" href="<?php echo url('no?uid='.$check['uid'].'&id='.$check['id']); ?>">拒绝</a>
            </td>
        </tr>
