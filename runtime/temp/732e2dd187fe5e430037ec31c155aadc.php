<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\phpStudy\WWW\ThinkPHP\public/../application/home/view/default/convenient\index.html";i:1511941640;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    $("#add").click(function () {
        ...
        int = parseInt(int);
        page = int+1;
        $.getJSON('/home/convenient/index',{page:page},function (notice) {
            var data = $.parseJSON(notice).list;
            $('#page').text($.parseJSON(notice).page);
            $.each(data,function (index) {

                    $.post('/home/convenient/path',{cover_id:data[index].cover_id,time:data[index].create_time},function (path) {
                        var path1 = path['path'];
                        var time = path['time'];
