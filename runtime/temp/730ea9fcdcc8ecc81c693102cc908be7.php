<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/service\view.html";i:1511677738;s:82:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <form id="form" method="post" class="form-horizontal doc-modal-form">
            ...
            <div id="tab1" class="tab-pane in tab1">
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <span><?php echo (isset($info['sn']) && ($info['sn'] !== '')?$info['sn']:''); ?></span>
                    </div>
                </div>
                <div class="form-item cf">
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <span><?php echo (isset($info['name']) && ($info['name'] !== '')?$info['name']:''); ?></span>
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">报修人电话:</label>
                    <div class="controls">
                        <span><?php echo (isset($info['tel']) && ($info['tel'] !== '')?$info['tel']:''); ?></span>
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">标题:</label>
                    <div class="controls">
                        <span><?php echo (isset($info['question']) && ($info['question'] !== '')?$info['question']:''); ?></span>
                    </div>
                </div>
                <div class="form-item cf">
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <label class="textarea input-large">
                            <textarea readonly="readonly"><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
                        </label>
                    </div>
                </div>
            </div>
