<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/service\edit.html";i:1511667604;s:82:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="main-title">
    <h2>
        <?php echo !empty($info['id'])?'编辑':'新增'; ?>维修
    </h2>
</div>
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        <label class="item-label">内容(详细叙述报修内容)<span class="check-tips"></span></label>
        <div class="controls">
            <textarea class="text input-large" name="content" style="height: 100px" ><?php echo (isset($info['content']) && ($info['content'] !== '')?$info['content']:''); ?></textarea>
        </div>
    </div>
