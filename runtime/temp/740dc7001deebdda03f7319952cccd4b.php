<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\ThinkPHP\public/../application/home/view/default/index\index.html";i:1512090202;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="container-fluid text-center">
            ...
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('home/ser/index'); ?>" class="navbar-link">服务</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="faxian.html" class="navbar-link">发现</a></p>
            </div>
            <div class="col-xs-3">
                <p class="navbar-text"><a href="<?php echo url('user/user/info'); ?>" class="navbar-link">我的</a></p>
            </div>
        </div>
    </nav>
    <!--导航结束-->
        ...
        <div class="serviceList text-center">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Convenient/index'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('room/index'); ?>">
                    ...
                    <div class="col-xs-4">
                        <a href="<?php echo url('Community/index'); ?>">
