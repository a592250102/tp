...
<div class="data-table table-striped">
    <table>
        ...
        <tr>
            ...
            <td><?php echo $service['question']; ?></td>
            <td><?php echo time_format($service['create_time']); ?></td>
            <td><?=$service['status']==1?'处理完成':'待处理'?></td>
            <td>
                <a title="编辑" href="<?php echo url('edit?id='.$service['id']); ?>">编辑</a>
                <a title="查看详情" href="<?php echo url('view?id='.$service['id']); ?>">查看详情</a>
