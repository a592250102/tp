<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/room\add.html";i:1512090063;s:82:"D:\phpStudy\WWW\ThinkPHP\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            <input type="text" class="text input-large" name="price" value="<?php echo (isset($room['pricle']) && ($room['pricle'] !== '')?$room['pricle']:''); ?>">
        </div>
    </div>
    <div class="form-item">
    ...
    <div class="form-item">
        ...
        <div class="controls">
            ...
            <input type="radio"  name="status" value="2" <?php echo !empty($room['status']) && $room['status']==0?'checked':''; ?>>否
        </div>
    </div>
    ...
    <div class="controls">
        ...
        <input type="hidden" name="logo" id="cover_id_<?php echo $field['name']; ?>" value="<?php echo $data[$field['name']]; ?>"/>
    ...
    <script type="text/javascript">
        ...
        function uploadPicture<?php echo $field['name']; ?>(file, data){
            ...
            var src = '';
            if(data.status){
                $("#cover_id_<?php echo $field['name']; ?>").val(data.path);
...
<div class="form-item">
        ...
        <div class="controls">
            <textarea name="description" style="width: 400px;height: 100px"><?php echo (isset($room['description']) && ($room['description'] !== '')?$room['description']:''); ?></textarea>
        </div>
    </div>
